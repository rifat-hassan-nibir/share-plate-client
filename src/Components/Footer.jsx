        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
          <div className="col-span-full hidden lg:col-span-1 lg:block">
            <a className="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">
              <img className="w-[150px]" src={logo} alt="Share Plate" />
            </a>
            <p className="mt-3 text-xs sm:text-sm text-gray-600 dark:text-neutral-400">© 2024 Share Plate. All rigths reserved.</p>
          </div>
          {/* End Col  */}
              ...
              <div className="hs-dropdown [--placement:top-left] relative inline-flex">
                ...
                >
                  ...
                  <a
                    ...
                    href="#"
                  >
                    <svg className="size-3 rounded-full" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-cn" viewBox="0 0 512 512">
                      <defs>
